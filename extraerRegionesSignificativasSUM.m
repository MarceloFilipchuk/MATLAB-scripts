filepath = {
'E:\Investigacion\Cefalea\Trabajos\QEEG FINAL\Resultados LORETA\Voxels TODO\Interictales vs Controles\LORETA Voxels';
'E:\Investigacion\Cefalea\Trabajos\QEEG FINAL\Resultados LORETA\Voxels TODO\Ictales vs Controles\LORETA Voxels';
'E:\Investigacion\Cefalea\Trabajos\QEEG FINAL\Resultados LORETA\Voxels TODO\Cronicos vs Controles\LORETA Voxels';
};
sigfinal = {}; % BORRAR
...
for findex = 1:length(filepath)
        ...
        if ~isempty(voxtable)
            ...
            for vindex = 1:size(voxtable, 1)
                if voxtable.P_value(vindex) < 0.05
                    tmp{tmpcounter, 1} = voxtable.Structure{vindex}; % extractAfter(voxtable.Structure{vindex}, ' - ');
    ...
    name = extractBetween(filepath{findex},'E:\Investigacion\Cefalea\Trabajos\QEEG FINAL\Resultados LORETA\Voxels TODO\',...
        '\LORETA Voxels');
    switch name{1}
...
writecell(uniquesigfinal, 'E:\Investigacion\Cefalea\Trabajos\QEEG FINAL\Regiones significativas sumadas.xls');    
...
writematrix(final, 'E:\Investigacion\Cefalea\Trabajos\QEEG FINAL\Regiones significativas.xls');
