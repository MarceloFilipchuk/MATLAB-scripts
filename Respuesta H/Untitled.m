...
eeglab
filename='E:\Investigacion\Cefalea\Trabajos\Respuesta H\EEG todos los picos\Controles\27549509.datspec';
...
plot( [1:1:99], powfft(1:99)./max(powfft(1:99)), [1:1:99], powpsd(2:100)./max(powpsd(2:100)) )


plot([1:1:99], 10*log10(powfft(1:99)./max(powfft(1:99))), [1:1:99], [10*log10(powpsd(2:100)./max(powpsd(2:100))) ])
